    ...
    <>
        ...
        <div className="page-wrapper">
          ...
          <header className="navbar navbar-expand-lg fixed-top">
            ...
            <path fill="currentColor"
              ...
              >
                <i className="ai-edit fs-xl me-2 ms-n1"></i>Register Now
              </a>
              <button
          ...
          <section className="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
            ...
            <div
              ...
              data-aos-offset="300"
            ></div>
            <div className="container position-relative zindex-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
              <h1
                className="display-3 text-center mx-auto pt-5 my-2 my-sm-4"
                style={{ maxWidth: "680px" }}
              >
                The Best Platform For Professional Services
              </h1>
              <svg
              ...
              <div className="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
                ...
                <div className="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
                  ...
                  >
                    ...
                    <p className="text-white opacity-80 mb-0">
                      Fusce lectus neque viverra risus lobortis adipiscing
                      integer pulvinar elementum. Lorem viverra tincidunt tortor
                      pellentesque.
                    </p>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p className="text-white opacity-80 mb-0">
                      Vulputate convallis odio donec massa facilisis sed nibh
                      rhoncus, maecenas. Maecenas morbi est neque pellentesque.
                    </p>
                  </div>
                </div>
                <div className="col-sm-6 col-lg-4 order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
                  ...
                  >
                    ...
                    <p className="text-white opacity-80 mb-0">
                      Fermentum convallis mi posuere rutrum turpis duis
                      facilisis integer. Rhoncus in in sit tellus velit quis
                      laoreet morbi orci sed.
                    </p>
                  </div>
                  <div
                    className="mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
                  ...
                  >
                    ...
                    <p className="text-white opacity-80 mb-0">
                      Arcu nisl aliquet vel pellentesque. Vitae nibh leo,
                      facilisis laoreet metus, felis. Egestas id enim turpis
          ...
          {/* <!-- Stats--> */}
          <div className="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            <div className="row pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-xxl-2 mt-md-3 mt-lg-0">
              <div className="col-lg-5 mb-5 mb-lg-0">
                <div className="h1 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">
                  ...
                  dolor Sed cumque asperiores vel.{" "}
                </div>
          ...
          <section className="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            <div className="row align-items-center pt-3 pt-sm-4 pt-lg-5 mt-md-3 mt-lg-0">
              <div className="col-md-6 pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
                {/* <!-- Binded images--> */}
                <div
                  className="binded-content rounded-5"
                  style={{ backgroundColor: "#971e3a" }}
                >
                  {/* <!-- Item--> */}
                  <div className="binded-item active" id="image1">
                    <svg
                      className="d-block position-absolute top-0 start-0 w-100 h-100 text-warning"
                      width="636"
                      height="640"
                      viewBox="0 0 636 640"
                      fill="currentColor"
            ...
            "navigation": {
              ...
              "nextEl": "#next-feature"
                  ...
                  >
                    <div className="swiper-wrapper">
                      ...
                      <div
                        ...
                        data-swiper-binded="#image1"
                      >
                        <div className="text-primary fs-xl fw-bold mb-3">
                          01
                        </div>
                        <h2 className="h1 mb-lg-4">
                          Odio pellentesque faucibus tortor
                        </h2>
                        <p className="mb-0">
                          Odio pellentesque faucibus tortor, sit ac mattis
                          tincidunt magna sit. Vitae elementum amet etiam
                          rhoncus, lacinia amet interdum pharetra tincidunt.
                          Ultricies faucibus ac morbi eget nunc pretium id.
                          Velit tristique scelerisque elit sociis convallis
                          ultricies aliquam.
                        </p>
                      </div>
                      {/* <!-- Item--> */}
                  ...
                  <div className="d-flex justify-content-center justify-content-md-start pt-4 mt-2 mt-lg-0 pt-lg-5">
                    <button
                      className="btn btn-icon btn-outline-primary rounded-circle me-3"
                      type="button"
                      id="prev-feature"
                    >
      ...
      "breakpoints": {
        ...
        "1200": {
          "slidesPerView": 6
            ...
            >
              {/* <!-- Pagination (bullets)--> */}
              <div className="swiper-pagination position-relative bottom-0 mt-2 pt-4 d-xl-none"></div>
            </div>
          </section>
          ...
          <section className="container py-5 mb-1 mb-sm-2 my-lg-3 my-xl-4 my-xxl-5">
            <div className="row justify-content-center pt-2 pt-sm-4 pb-4 mb-2 mb-lg-3">
              <div className="col-lg-8 col-xl-7 col-xxl-6 text-center pt-2">
                <h2 className="h1 mb-1">Testimonials from beloved Customers</h2>
              </div>
            </div>
            <div
              className="swiper pb-2 pb-sm-4"
              data-swiper-options='{
      "slidesPerView": 1,
      "spaceBetween": 24,
      "loop": true,
      ...
      "breakpoints": {
              ...
              <div className="swiper-wrapper pt-5">
                ...
                <div className="swiper-slide h-auto">
                  <div className="card border-0 bg-faded-info h-100 text-center">
                    <div className="polygon-avatar bg-info mx-auto translate-middle-y">
                      <img
                        src="assets/img/landing/mobile-app-showcase/testimonials/01.png"
                        alt="Nick Williams"
                      />
                    </div>
                    <div className="card-body pt-0 mt-n4">
                      <p className="card-text fs-xl">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nunc quis libero vitae sem ornare ornare. Aliquam ut
                        sapien vitae quam blandit egestas. Quisque nulla elit,
                        fermentum et tincidunt tempor, rutrum at leo. Curabitur
                        massa quam, aliquam eu sapien sed.
                      </p>
                    </div>
                    <div className="card-footer border-0 pt-0">
                      <div className="h4 mb-1">Nick Williams</div>
                      <span>Customer</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="swiper-slide h-auto">
                  <div className="card border-0 bg-faded-warning h-100 text-center">
                    <div className="polygon-avatar bg-warning mx-auto translate-middle-y">
                      <img
                        src="assets/img/landing/mobile-app-showcase/testimonials/02.png"
                        alt="Lili Bocouse"
                      />
                    </div>
                    <div className="card-body pt-0 mt-n4">
                      <p className="card-text fs-xl">
                        Proin interdum purus non quam convallis, quis dignissim
                        leo cursus. Praesent finibus elit nisl, sed ultrices
                        elit lobortis in. Donec laoreet sit amet nulla quis
                        hendrerit. Praesent venenatis mattis ante. Praesent
                        justo elit, suscipit a libero sit amet, luctus posuere
                        mi.
                      </p>
                    </div>
                    <div className="card-footer border-0 pt-0">
                      <div className="h4 mb-1">Lili Bocouse</div>
                      <span>Customer</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="swiper-slide h-auto">
                  <div className="card border-0 bg-faded-primary h-100 text-center">
                    <div
                      className="polygon-avatar mx-auto translate-middle-y"
                      style={{ backgroundColor: "#971e3a" }}
                    >
                      <img
                        src="assets/img/landing/mobile-app-showcase/testimonials/04.png"
                        alt="Esther Howard"
                      />
                    </div>
                    <div className="card-body pt-0 mt-n4">
                      <p className="card-text fs-xl">
                        Viverra aliquam interdum mauris facilisi commodo euismod
                        sit est. Et auctor diam a ac vitae vestibulum, eu.
                        Tortor id aliquet rhoncus at orci et tempus, dictum
                        turpis. Purus sit porta lacus, velit. Bibendum at nunc
                        et, ac id vitae nibh semper in dignissim ac nascetur
                        lorem et.
                      </p>
                    </div>
                    <div className="card-footer border-0 pt-0">
                      <div className="h4 mb-1">Esther Howard</div>
                      <span>Customer</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="swiper-slide h-auto">
                  <div className="card border-0 bg-faded-danger h-100 text-center">
                    <div className="polygon-avatar bg-danger mx-auto translate-middle-y">
                      <img
                        src="assets/img/landing/mobile-app-showcase/testimonials/03.png"
                        alt="Jane Cooper"
                      />
                    </div>
                    <div className="card-body pt-0 mt-n4">
                      <p className="card-text fs-xl">
                        Nam arcu ut in bibendum tincidunt quam massa vitae
                        viverra sem eget. Felis morbi augue cras praesent arcu
                        purus non id consequat dignissim sollicitudin tincidunt
                        dui, dui felis ut ultricies vestibulum ipsum ullamcorper
                        nunc at massa a aliquam massa lacus enim.
                      </p>
                    </div>
                    <div className="card-footer border-0 pt-0">
                      <div className="h4 mb-1">Jane Cooper</div>
                      <span>Customer</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-4 text-center text-md-start">
                  ...
                  <p className="pb-3 pb-sm-4">
                    Et felis vitae ac venenatis lacus cras etiam risus
                    scelerisque auctor adipiscing in a porta
                  </p>
                    ...
                    <div className="accordion-item bg-light">
                      ...
                      >
                        <div className="accordion-body fs-sm">
                          ...
                          volutpat. Proin egestas, mauris ut semper semper,
                          ipsum felis mattis ligula, et porttitor ante arcu nec
                          ante. Aliquam congue est eu turpis sollicitudin, et
                    ...
                    <div className="accordion-item bg-light">
                      ...
                      >
                        <div className="accordion-body fs-sm">
                          ...
                          vel, tempus dignissim libero. Curabitur sed odio in
                          odio elementum cursus.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item bg-light">
                      ...
                      >
                        <div className="accordion-body fs-sm">
                          ...
                          lorem, in efficitur odio efficitur vel. Integer
                          mattis, neque malesuada sagittis porttitor, enim
                          tortor ullamcorper diam, id eleifend sem mauris at
                          turpis. Curabitur sed nisi nec ligula dictum.
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="bg-secondary">
          <div className="container">
            <div className="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
              <div
              ...
              <div className="row align-items-center position-relative zindex-2">
                <div
                  className="col-md-6 col-lg-5 col-xl-4 offset-lg-1 pb-sm-3 pt-5 py-md-0 py-lg-5"
                  data-aos="fade-up"
                ...
                >
                  <h2 className="display-3 text-white text-center text-md-start mb-4 mb-lg-5">
                    Ready to
                    <br className="d-none d-xxl-inline" />
                    Get Started?
                  </h2>
                  <div className="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start">
                    <a
                      className="btn btn-light btn-lg px-3 py-2 me-sm-3 mb-3 mb-sm-0"
                      href="#"
                    >
                      <img
                        className="mx-1"
                    ...
                    <a className="btn btn-light btn-lg px-3 py-2" href="#">
                      <img
                        className="mx-1"
                        src="assets/img/market/googleplay-dark.svg"
                        width="135"
          ...
          <div className="container pt-md-2 pt-lg-3 pt-xl-4">
            <div className="row pb-4 pb-md-5 pt-sm-2 mb-lg-2">
              <div className="col-md-4 col-lg-3 pb-2 pb-md-0 mb-4 mb-md-0">
                <a
                  className="navbar-brand text-nav py-0 mb-3 mb-md-4"
                  href="index.html"
                >
                  <span className="text-primary flex-shrink-0 me-2" />
            ...
            <p className="fs-sm mb-0">
              <span className="opacity-70">
                &copy; All rights reserved | Root Delivery
              </span>
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            <div className="modal-content">
              <div className="modal-header d-block position-relative border-0 pb-0">
                <form
                  className="position-relative w-100 mt-2 mb-4"
                  method="post"
                  action="./success.html"
                />
              </div>
              <div className="modal-body pt-1">
                <h2 className="mb-4" style={{ textAlign: "justify" }}>
                  Enter your Info
                </h2>
                <div className="row">
                  ...
                  <div className="col-lg-6 pb-3">
                    ...
                    <select
                      ...
                      required
                    >
                      <option>Select Servicing Location</option>
